    ...
    protected MapV2Extension applyImpl(@NotNull Project project) {
        ...
        final var unpickHashedJar = tasks.register(
            ...
            task -> {
                ...
                task.getOutputFile().convention(this.provideMappedMinecraftBuildFile(
                    quiltExt.getMinecraftVersion() + "-" + Classifiers.INTERMEDIATE_UNPICKED + "." + Extensions.JAR
                ));
            }
        );
        ...
        final var mapNamedJar = tasks.register(
            ...
            task -> {
                ...
                task.getOutputJar().convention(this.provideMappedMinecraftBuildFile(
                    quiltExt.getMinecraftVersion() + "-" + Classifiers.NAMED + "." + Extensions.JAR
                ));
            }
        );
