...
public class MergeTinyV2Task extends DefaultMappingsTask {
    ...
    public void mergeMappings() throws Exception {
        ...
        File autoGeneratedEnumMappings = this.<AddProposedFieldMappingsTask>getTaskByName("insertAutoGeneratedEnumMappings").getOutputMappings();

        File orderedResultMappings = new File(fileConstants.tempDir, "merged-reordered.tiny");
        ...
        String[] args = {
                ...
                orderedResultMappings.getAbsolutePath(),
